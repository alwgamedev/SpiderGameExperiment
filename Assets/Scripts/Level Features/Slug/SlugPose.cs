...
public struct SlugPose
{
    ...
    public readonly Vector4 C0 => new(p0.x, p0.y, v0.x, v0.y);
    public readonly Vector4 C1 => new(p1.x, p1.y, v1.x, v1.y);
    public readonly Vector4 C2 => new(p2.x, p2.y, v2.x, v2.y);
    ...
    {
        var d0 = MathTools.MaxDifference(pose1.C0, pose2.C0);
        var d1 = MathTools.MaxDifference(pose1.C1, pose2.C1);
        var d2 = MathTools.MaxDifference(pose1.C2, pose2.C2);
